...
**A1.** Give the present tense form for each (5 marks):
1. nam, 1st person singular (I bow): ___
2. pūj, 3rd person singular (he worships): ___
3. gam, 2nd person singular (you go): ___
4. dā, 1st person singular (I give): ___
5. paśy (dṛś), 3rd person plural (they see): ___

**A2.** Conjugate "bhaj" (to adore) in all three persons, singular (3 marks):
- 3rd: ___
- 2nd: ___
- 1st: ___

**A3.** Conjugate "smṛ" (to remember) in all three persons, singular (3 marks):
- 3rd: ___
- 2nd: ___
- 1st: ___

**A4.** What is the difference between parasmaipada and ātmanepada? Give one example verb of each (4 marks).

---

## Section B: Translation (15 marks)

**B1.** Translate into Sanskrit (use 1st person singular) (5 marks):
1. I bow to Śiva
2. I sing a hymn
3. I go to the temple
4. I offer a flower
5. I meditate on the deity

**B2.** Translate into English (5 marks):
1. bhaktaḥ devam pūjayati
2. mantram japāmi
3. śivaḥ rakṣati
4. dīpam jvālayāmi
5. gāyāmi stotram

**B3.** Change each sentence from 1st person to 3rd person (5 marks):
1. namāmi → ___
2. gacchāmi → ___
3. dadāmi → ___
4. paśyāmi → ___
...
## Section C: Sentence Building (15 marks)

**C1.** Complete each sentence with the correct verb form (5 marks):
1. aham devam ___ (I worship) [pūj]
2. bhaktaḥ mandiram ___ (the devotee goes) [gam]
3. tvam mantram ___ (you chant) [jap]
4. devī bhaktam ___ (the goddess protects) [rakṣ]
5. vayam stotram ___ (we sing) [gai]

**C2.** Build 5 sentences describing a morning pūjā, using 5 different verbs (10 marks):
1. ___
2. ___
3. ___
4. ___
...
## Section D: Negation & Questions (5 marks)

**D1.** Negate each sentence (3 marks):
1. jānāmi → ___
2. paśyāmi → ___
3. tyajāmi → ___

**D2.** What does each sentence mean? (2 marks):
1. na tyajāmi devam
2. kiṃ paśyasi?

---

## Section E: Milestone — Describe Your Worship (10 marks)

Write a sequence of at least 8 Sanskrit sentences describing your daily worship (real or imagined). Use at least 8 different verbs. Include subjects, objects, and verbs.
